...
/**
 * Hat_farmer - King_Of_Creepers
 * Created using Tabula 7.0.1
 */
public class Hat_farmer extends ModelBase {
    ...
    public Hat_farmer() {
        ...
        this.Rim_Layer = new ModelRenderer(this, 15, 39);
        this.Rim_Layer.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.Rim_Layer.addBox(-8.0F, -5.0F, -8.0F, 16, 0, 16, 0.0F);
