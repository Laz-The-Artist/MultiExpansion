...
import multiteam.multiexpansion.main.event.loot.AdditionWithChanceToBlockLootModifier;
...
public class EventHandlerModBus {
    ...
    public static void registerLootModifierSerializers(final RegistryEvent.@NonNull Register<GlobalLootModifierSerializer<?>> event){
        event.getRegistry().registerAll(
                new AdditionToBlockLootModifier.Serializer().setRegistryName(new ResourceLocation(MultiExpansion.MOD_ID, "addition_to_block_loot")),
                new AdditionWithChanceToBlockLootModifier.Serializer().setRegistryName(new ResourceLocation(MultiExpansion.MOD_ID, "addition_with_chance_to_block_loot"))
        );
    }
}
