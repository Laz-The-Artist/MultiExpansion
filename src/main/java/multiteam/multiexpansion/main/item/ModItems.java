...
public class ModItems {
    ...
    public static final RegistryObject<Item> EMERALD_APPLE = Registration.ITEMS.register("emerald_apple", () -> new EmeraldApple(new Item.Properties().tab(MultiExpansion.ME_MAIN).food(EMERALD_APPLE_PROP)));
